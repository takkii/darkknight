...
config :darkknight, DarkknightWeb.Endpoint,
  ...
  watchers: [
    ...
    sass: {
      DartSass,
      :install_and_run,
      [:darkknight, ~w(--embed-source-map --source-map-urls=absolute --watch)]
    }
  ]
...
config :darkknight, DarkknightWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/darkknight_web/router\.ex$"E,
      ~r"lib/darkknight_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :darkknight, dev_routes: true
